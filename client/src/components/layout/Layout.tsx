...
import { Activity, BarChart3, Building2, FileSearch, Gauge, Search, Sparkles, X } from "lucide-react";
...
const selectClass = "h-8 min-w-0 rounded-lg border border-white/10 bg-[#0c1929] px-2 text-xs text-slate-300 outline-none transition-colors hover:border-white/20 focus:border-cyan-400/40";
...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#07101c] font-sans text-slate-200">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#08111f]/95 backdrop-blur-xl">
        ...
        <div className="border-t border-white/[0.06] bg-[#0a1524]/90">
      ...
      <main className="min-h-[calc(100vh-109px)] bg-[radial-gradient(circle_at_top_right,rgba(14,116,144,0.08),transparent_34%),linear-gradient(180deg,#07101c_0%,#050a12_100%)]">{children}</main>
      <CommandPalette />
    </div>
  );
}
